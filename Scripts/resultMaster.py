...
class ResultMaster:
    # Define the path to the single database file
    @staticmethod
    def get_db_path():
    ...
    def create(tablename):
        ...
        db_path = ResultMaster.get_db_path()
    ...
    def insert(tablename, *params):
        ...
        try:
            ...
            print("Record already present in ResultMaster. Unique constraint violation.")
            print(f"Error: {e}")
    ...
    def getDetails(tablename, TcNo):
        ...
        try:
            ...
            # If no rows are found, return an appropriate message
            if not results:
